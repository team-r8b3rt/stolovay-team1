...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .menu-open-btn:focus-visible { outline: 3px solid var(--color-accent); outline-offset: 4px; }
...
@app.route("/api/loads")
def api_loads():
    """Возвращает актуальную загруженность всех корпусов для плавного обновления карты."""
